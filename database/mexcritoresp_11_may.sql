...
--
-- Name: c_lect(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: del_lect(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: up_lect(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: writer_reg(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: escritor_libro_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: escritor_libro_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: lector_libro_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: lector_libro_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: escritor_libro id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: lector_libro id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: escritor_libro_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('escritor_libro_id_seq', 1, false);
...
--
-- Name: lector_libro_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
SELECT pg_catalog.setval('libro_id_seq', 1, false);
...
\N	creacion nuevo lector	2017-05-10
\N	creacion nuevo lector	2017-05-10
\N	actualizacion de lector	2017-05-10
\N	creacion de autor	2017-05-10
\N	eliminacion de un autor	2017-05-10
\N	creacion de autor	2017-05-10
\N	actualizacion de autor	2017-05-10
\N	eliminacion de un autor	2017-05-10
\N	creacion de autor	2017-05-10
\N	eliminacion de un autor	2017-05-10
\N	creacion de autor	2017-05-10
...
\N	actualizacion de autor	2017-05-10
\N	eliminacion de un autor	2017-05-10
\N	creacion de autor	2017-05-11
\N	actualizacion de autor	2017-05-11
\N	eliminacion de un autor	2017-05-11
\N	creacion nuevo lector	2017-05-11
\N	actualizacion de lector	2017-05-11
\N	actualizacion de lector	2017-05-11
\N	actualizacion de lector	2017-05-11
\N	actualizacion de lector	2017-05-11
\N	actualizacion de lector	2017-05-11
...
\N	creacion de autor	2017-05-11
\N	actualizacion de autor	2017-05-11
\N	eliminacion de lector	2017-05-11
\N	eliminacion de lector	2017-05-11
\N	creacion nuevo lector	2017-05-11
\N	actualizacion de lector	2017-05-11
\N	eliminacion de lector	2017-05-11
...
--
-- Name: escritor_libro escritor_libro_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: lector_libro lector_libro_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: lector create_lect; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: lector delete_lect; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: lector update_lect; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: escritor_libro escritor_libro_ref_libro_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY escritor_libro
    ADD CONSTRAINT escritor_libro_ref_libro_fkey FOREIGN KEY (ref_libro) REFERENCES libro(id);
...
--
-- Name: lector_libro lector_libro_ref_libro_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY lector_libro
    ADD CONSTRAINT lector_libro_ref_libro_fkey FOREIGN KEY (ref_libro) REFERENCES libro(id);
